...
from texcompile import PDF_CACHE, PDF_LOCK, compile_tex, safe_pdf_name
...
PORT = int(os.environ.get("PICA_FLASK_PORT", os.environ.get("PICA_PORT", "5001")))
...
def main() -> None:
    ...
    print(f"ResuForm templates edition (Flask) -> {url}")
    print("Original app is unchanged at http://127.0.0.1:5000/ or http://127.0.0.1:8080/")
